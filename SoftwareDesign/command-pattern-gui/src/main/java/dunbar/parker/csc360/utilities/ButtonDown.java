...
public class ButtonDown implements Command {
	
	private Button button;
	
	private String previousPosition;
	
	public ButtonDown(Button b, String currentPosition) {
		this.setButton(b);
	...
	public Command clone() {
		ButtonDown b = new ButtonDown(this.getButton(), this.getButton().getPosition());
		return b;
	}
