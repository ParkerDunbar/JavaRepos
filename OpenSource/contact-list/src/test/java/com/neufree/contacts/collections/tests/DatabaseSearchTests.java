...
//		System.out.println("Request Completed in "+ ((endTime - startTime) /1000000.0) + " ms");
		...
		System.out.println(d.searchByFirstName("ARWDG"));
		System.out.println(d.searchByLastName("AZKSY"));
		System.out.println(d.searchByPrimaryEmail("SOOTY"));
		System.out.println(d.searchByPrimaryPhone("46266"));
